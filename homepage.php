...
<meta name="keywords" content="חשבוניות" />
             ...
             <!--header start here-->
				<div class="header-main">
					...
					<!--<div class="w3layouts-left">
								...
								<!--//end-search-box--
								<div class="w3-search-box" style="border:0;direction:rtl;">
									כתובת המייל שלך:
...
<!--four-grids here-->
		<div class="four-grids">
					<div class="col-md-3 four-grid" onclick="window.location.href = 'calendar.php';" style="cursor:pointer">
					...
					<div class="col-md-3 four-grid" onclick="window.location.href = 'report.php';" style="cursor:pointer">
						<div class="four-agileinfo">
							<div class="icon">
								<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3>צפייה בחשבונות</h3>
							</div>
							
						</div>
					</div>
					<div class="col-md-3 four-grid" onclick="window.location.href = 'insert.php';" style="cursor:pointer">
						<div class="four-w3ls">
							<div class="icon">
								<i class="glyphicon glyphicon-pencil" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3>הקלדת הוצאות/הכנסות ידנית</h3>
							</div>
							
						</div>
					</div>
					<div class="col-md-3 four-grid" onclick="window.location.href = 'guide.php';" style="cursor:pointer">
						<div class="four-wthree">
							<div class="icon">
								<i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3>שליחת חשבונות במייל</h3>
							</div>
